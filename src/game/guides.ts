...
export const GUIDES: Record<string, Guide> = {
  ...
  thirds: {
    ...
    cards: [
      ...
      {
        kind: 'read',
        text: 'But 3rds come in two sizes. Count the semitones!',
        picture: { clef: 'treble', notes: ['C4', 'E4', 'D4', 'F4'] },
      },
      {
        kind: 'read',
        text: 'C to E is 4 semitones: a major 3rd.',
        picture: { clef: 'treble', notes: ['C4', 'E4'], labels: ['C', 'E'] },
        keys: { notes: ['C4', 'C#4', 'D4', 'D#4', 'E4'], labels: [undefined, '1', '2', '3', '4'] },
        sound: ['C4 E4'],
      },
      {
        kind: 'read',
        text: 'D to F is only 3 semitones: a minor 3rd.',
        picture: { clef: 'treble', notes: ['D4', 'F4'], labels: ['D', 'F'] },
        keys: { notes: ['D4', 'D#4', 'E4', 'F4'], labels: [undefined, '1', '2', '3'] },
        sound: ['D4 F4'],
      },
      {
        kind: 'read',
        text: 'Listen: a major 3rd sounds bright. A minor 3rd sounds darker.',
        picture: { clef: 'treble', notes: ['C4 E4', 'D4 F4'], labels: ['major', 'minor'] },
        sound: ['C4 E4', 'D4 F4'],
      },
      {
        kind: 'quiz',
        text: 'Count the semitones. Major or minor 3rd?',
        picture: { clef: 'treble', notes: ['E4', 'G4'] },
        keys: { notes: ['E4', 'G4'] },
